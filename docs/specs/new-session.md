...
- `NS-prompt-history`: A small history icon beside the Prompt label opens a
  scrollable list of the 20 most recent nonblank user prompts saved by Hitch,
  newest first, across sessions and projects. Include follow-up prompts and
...
- `NS-history-storage`: Save accepted browser submissions, including steering
  ...
  20 nonblank submissions. History starts empty on upgrade and collects new
