...
- Page-level actions should live in that upper-right page menu instead of the page body header. For example, the Inbox visible-project selector is a menu item.
