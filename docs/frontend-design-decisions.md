...
- Page-level actions should live in that upper-right page menu instead of the page body header. For example, standing order actions such as "New order" and "Run all" are menu items.
